const paths = {
  ...
  phone: '<path d="M7.3 3.7 5.6 4.8c-.9.6-1.3 1.8-.9 2.8 2 5.2 6.1 9.3 11.3 11.3 1 .4 2.2 0 2.8-.9l1.1-1.7c.4-.7.3-1.6-.3-2.1l-2.8-2.2c-.6-.5-1.5-.4-2 .2l-1.2 1.5a14.5 14.5 0 0 1-3.3-3.3l1.5-1.2c.6-.5.7-1.4.2-2L9.4 4c-.5-.6-1.4-.7-2.1-.3z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>',
