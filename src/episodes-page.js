...
function renderFeatured() {
  ...
  node.innerHTML = `<div class="featured-conversation-media">${episodeCard({ ...episode, thumbnail: episodeThumbnailUrl(episode) })}</div><div class="featured-conversation-copy"><p class="content-label">Featured conversation</p><h3>${escapeHtml(episode.title)}</h3><a class="button button-gold" href="${url}" target="_blank" rel="noopener">Watch on YouTube</a></div>`;
