export const topicPages = [
  {
    ...
    description: "Explore leadership interviews from Alana — All Over the Place about responsibility, decision-making, resilience, service, and leading through action.",
  ...
  },
  {
    ...
    description: "Explore Alana — All Over the Place conversations with South Florida leaders, organizations, advocates, entrepreneurs, and people strengthening their communities.",
  ...
  },
  {
    ...
    description: "Business and entrepreneurship interviews from Alana — All Over the Place covering ownership, growth, innovation, resilience, customer experience, and building something that lasts.",
  ...
  },
  {
    ...
    description: "Explore public service interviews from Alana — All Over the Place with civic leaders, veterans, law enforcement professionals, public officials, and community servants.",
  ...
  },
  {
    ...
    description: "Explore conversations from Alana — All Over the Place about faith, calling, perseverance, conviction, purpose, and the experiences that shape how people move forward.",
  ...
  },
  {
    ...
    description: "Explore wellness conversations from Alana — All Over the Place about healthcare, fitness, resilience, performance, personal safety, recovery, and living well.",
  ...
  },
  {
    ...
    description: "Explore technology interviews from Alana — All Over the Place covering artificial intelligence, cybersecurity, fraud prevention, digital engagement, innovation, and emerging tools.",
  ...
  },
  {
    ...
    name: "Stepping Up",
    title: "Stepping Up",
    description: "Meet people on Alana — All Over the Place who saw a need, took responsibility, and stepped up to serve their communities, country, organizations, or neighbors.",
