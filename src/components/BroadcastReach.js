    ...
    <section class="section broadcast-reach" id="on-air" aria-labelledby="broadcast-reach-title">
      <div class="shell">
        ...
        <div class="broadcast-artwork-frame reveal">
          ...
          >
          <a
            class="broadcast-hotspot broadcast-hotspot-listen"
            href="${site.trueOldiesLive}"
            target="_blank"
            rel="noopener"
            aria-label="Listen live to the True Oldies Channel"
          ><span class="sr-only">Listen Live</span></a>
          <a
            class="broadcast-hotspot broadcast-hotspot-episodes"
            href="/episodes"
            aria-label="View The Alana Show episodes"
          ><span class="sr-only">View Episodes</span></a>
        </div>
