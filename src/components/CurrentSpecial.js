    ...
    <section class="current-special current-special--${theme}" aria-labelledby="current-special-heading" data-current-special>
      <div class="shell">
        <div class="current-special-panel">
          <div class="current-special-accent" aria-hidden="true"><span>The Alana Show</span></div>
          <div class="current-special-copy">
            ...
            <a class="button button-gold current-special-cta" href="${escapeHtml(config.ctaHref)}" target="_blank" rel="noopener noreferrer">${escapeHtml(config.ctaLabel)} ${icon("arrow")}</a>
